...
public class TicketekTest {
	...
	public void init() {
		...
		ticketek.registrarSede("Teatro Colón", "libertad 621", 1000, asientosPorFilaTeatro, sectores_teatro,
				capacidad_teatro, porcentajeAdicionalTeatro);
		ticketek.registrarSede("Teatro San Martín", "avenida corrientes 1530", 1000, asientosPorFilaTeatro,
		...
		String[] sedesSirenita = { "Teatro Gran Rex", "Teatro Gran Rex", "Teatro Colón", "Teatro Colón",
				"Teatro Gran Rex" };
		String[] fechasReyLeon = { "26/07/25", "29/07/25", "31/08/25", "31/09/25", "01/10/25" };
		String[] sedesReyLeon = { "Teatro Gran Rex", "Teatro Gran Rex", "Teatro Colón", "Teatro Colón",
				"Teatro Gran Rex" };
		...
		ticketek.venderEntrada("Stand up Comedy", "10/04/25", "nores@campus.ungs.edu.ar", "1234", "VIP",
				new int[] { 11, 12, 13, 14 });
		ticketek.venderEntrada("Ballet Clásico", "01/03/25", "nores@campus.ungs.edu.ar", "1234", "Baja",
				new int[] { 1, 2, 3, 4 });
	}
	...
	public void ej04_venderEntradaTeatroContraseniaInvalida() {
		...
		ticketek.venderEntrada("El Rey León", "29/07/25", "nores@campus.ungs.edu.ar", "12345", "VIP", asientos);
	}

	@Test(expected = RuntimeException.class)
	public void ej04_venderEntradaUsuarioInvalido() {
		int[] asientos = { 10, 9, 1, 2 };
		ticketek.venderEntrada("El Rey León", "29/07/25", "falsoMail@campus.ungs.edu.ar", "12345", "VIP", asientos);
	}

	@Test
	public void ej04_venderEntradaEstadio() {
		List<IEntrada> entradas = ticketek.venderEntrada("Coldplay en vivo", "28/07/25", "nores@campus.ungs.edu.ar",
				"1234", 3);
	...
	public void ej05_listarFuncionesDeEspectaculo() {
		...
		// - (31/07/2025) Teatro Colón - Platea VIP: 30/50 | Platea Común: 60/70 |
